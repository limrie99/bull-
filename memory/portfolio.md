...
- **MON 8/31 OPEN — EXECUTE THE CASH DEPLOY.** Per Lauren's 8/27 standing instruction: enlarge the SPY market-floor sleeve so whole-book cash lands near **$10,000** (leave the ~10% buffer, never below it). Size from live Monday-open prices. This was due Friday and got missed twice — Monday's routine must run it (unless Lauren countermands in inbox first).
