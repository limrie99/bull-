...
## Cash-deployment / market-floor policy (added 2026-08-07 — Lauren APPROVED Option B; amended 2026-08-24 — Lauren APPROVED a larger floor)
...
**Amendment (Lauren, 2026-08-24 ~14:14 CT): "Edit the strategy to put more idle cash in the SPY floor."** The first floor (32 SPY shares, built 8/10–8/11, ~24% of book) moved cash from ~75% toward ~49%. The 8/21 weekly review said do **not** auto-size the floor bigger unless an up-tape trigger fired (SPY ≥ +1.5% week AND we still lag >1 pt with the floor performing). That trigger did **not** fire. This is a **new explicit owner instruction** — treat it like the 8/7 "Edit strat to go forward" approval. Owner instruction overrides the unfired trigger.
...
- **Target cash band (amended 2026-08-24):** move whole-book cash from ~49% toward the **30–40%** band (was ~50–55%). Never deploy so much that total cash falls below the **10–20% minimum buffer**.
- **Next tranche (authorized 2026-08-24):** about **10–15% of equity** in additional SPY, sized from **live prices** at the next market-open so that after the fill, whole-book cash lands in the 30–40% band and never below the 10–20% buffer. The floor may grow toward **~35–40% of the book**.
- **The floor is its OWN sleeve, NOT a conviction pick.** Therefore it is **exempt** from: (a) the ≤20%-per-single-position cap (it is a diversified index, not single-company risk — a single SPY lot may exceed 20% of equity), (b) the max-5-positions cap, and (c) the max-3-buys/week cap. Those three caps govern individual stock picks; the index floor does not consume their budget. The **10–20% minimum cash buffer still applies** to the whole book.
...
- **The ≥70 Conviction gate is UNCHANGED and was NOT lowered.** The floor is explicitly the alternative to loosening the quality bar: idle cash matches the market via the index while the stock sleeve keeps requiring 2+ signals AND Conviction ≥70. We do not force-buy mediocre individual names to deploy cash. Every individual-stock rule stays exactly as written: Conviction ≥70 + 2 signals, −7% hard stop, 10% trailing once +5%, max 5 stocks, max 20% per stock, max 3 new stock buys/week, high-beta ≤10% starter, cold-start rule.
- **Execution (first floor — DONE):** built at the Mon 2026-08-10 / Tue 2026-08-11 market-opens (32 SPY shares, ~24% of book, no stop). Logged as "MARKET-FLOOR / index sleeve, no stop."
- **Execution (next tranche):** build the next SPY tranche at the **next market-open routine (Tue 2026-08-25, 8:30 AM CT)**. Compute exact shares at the live open price so the resulting cash band is 30–40% and the 10–20% buffer is respected; log the fill to trade-log.md like any buy (note "MARKET-FLOOR / index sleeve, no stop"). If Lauren countermands before the open (inbox), stand down. Do **not** place this tranche intra-day on 8/24 — wait for the Tuesday open.
- **Rebalance:** if the stock sleeve later grows (new ≥70 buys) such that total cash would drop below the 10–20% buffer, trim the floor first to make room — the floor is the shock-absorber, conviction picks take priority for the alpha budget.
...
- **2026-08-24 (~14:14 CT, per Lauren's live instruction "Edit the strategy to put more idle cash in the SPY floor") — RULE CHANGE: enlarge the S&P 500 market floor; lower the target cash band to 30–40%.** Lauren explicitly approved putting more idle cash into the existing SPY floor. This is **not** a silent edit and **not** a lowering of the buy gate. Context: the 8/21 weekly review said do NOT auto-size the floor bigger unless an up-tape trigger fired; that trigger did NOT fire. Owner instruction overrides the unfired trigger — same governance pattern as the 8/7 "Edit strat to go forward" approval. What this changes: (1) target whole-book cash band moves from ~50–55% to **30–40%**; (2) a next SPY tranche of about **10–15% of equity** is authorized for the **Tue 2026-08-25 8:30 AM CT market-open**, sized from live prices so cash lands in-band and never below the 10–20% buffer; (3) the floor may grow toward **~35–40% of the book**. What this deliberately does NOT change: the floor remains its own sleeve with **no stop** and still exempt from the ≤20% / max-5 / max-3-buys conviction caps; the **≥70 Conviction gate and 2-signal rule are untouched**; every individual stock still keeps −7% hard stop / 10% trailing / max 5 stocks / max 20% per stock / max 3 new stock buys per week / high-beta ≤10% starter / cold-start. Execution deferred to Tuesday's market-open (do not trade on this edit). Weekend/overnight veto window open for Lauren.
